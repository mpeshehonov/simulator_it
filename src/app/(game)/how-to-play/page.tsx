      ...
      <div className="mx-auto max-w-md space-y-6">
        ...
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-sm">Цель</CardTitle>
          </CardHeader>
        ...
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-sm">Энергия и действия</CardTitle>
          </CardHeader>
          <CardContent className="space-y-2 text-xs text-muted-foreground">
            <p>
            ...
            <p>Энергия понемногу восстанавливается со временем сама.</p>
          </CardContent>
        </Card>

        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-sm">Задания</CardTitle>
          </CardHeader>
          <CardContent className="space-y-2 text-xs text-muted-foreground">
            <p>
        ...
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-sm">Навыки и собеседование</CardTitle>
          </CardHeader>
          <CardContent className="space-y-2 text-xs text-muted-foreground">
            <p>
